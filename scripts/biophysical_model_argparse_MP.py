...
def run_biophysical_model(inputList,binding_sites,translation_rates):        
    ...
    try:
        ...
        (sortedSingleBindingSiteList_RNAFolding, sortedDoubleBindingSiteList_RNAFolding) = calculateFoldingFreeEnergies(use_MP, sequence, CsrA_siteFoldingConstraint, sortedSingleBindingSiteList[0:3], sortedDoubleBindingSiteList[0:3]) 
