...
#from RBS_Calculator_Vienna import RBS_Calculator
...
CsrA_siteFoldingConstraint = "xxxxx"
...
def predictTranslationRatesSingleSites(inputList):
    ...
    for start in start_codon_list:
        ...
        outputList.append((start_pos, tir_ON, tir_ON / tir_OFF))
    return outputList
...
if __name__ == "__main__":
    ...
    filename = '../data/Rsm_seqs_from_proteomics.xlsx'

    outputFilename = '../data/proteomics_out_20200819.xls'
    ...
    if (use_MP):
        ...
        for (gene, sequence) in sequenceDict.items():
            try:
                ...
                sequence.upper()
                (sortedSingleBindingSiteList, sortedDoubleBindingSiteList) = calculateSortedBindingSitesbyEnergy(sequence, RsmA_MD_freeEnergyMatrix)
